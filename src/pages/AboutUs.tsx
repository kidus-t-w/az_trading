...
import wearHouse4 from '/imgs/wearHouse/wear house 4.png'
import certificate from '/imgs/certificate.jpg'
    ...
    <>
      ...
      <div className="mt-16">
        <div className="container flex flex-col md:flex-row items-center md:items-start bg-white p-4">
          ...
          />
          <div className="md:ml-8 mt-4 md:mt-0 md:w-1/2 h-[400px] flex flex-col justify-center">
            <h2 className="text-xl font-bold mb-4">AZ Trading PLC </h2>
              <p className="text-gray-700 mb-2">
      ...
      <div className="mt-16">
        <div className="container flex flex-col md:flex-row-reverse items-center md:items-start bg-white p-4">
          <img
            ...
            className="w-full md:w-[600px] h-auto rounded-2xl m-2 shadow-lg"
          />
          <div className="md:mr-8 mt-4 md:mt-0 md:w-1/2 h-[400px] flex flex-col justify-center">
            <h2 className="text-xl font-bold mb-4">AZ Trading PLC </h2>
            <p className="text-gray-700 mb-2">
              AZ Trading – Leading supplier of Beans & Pulses, Oil Seed, Cereal, & Spices Az Trading
              P.L.C is a leading supplier of premium quality product range of beans & Pulses, Oil
              ...
              best quality products, without any compromise to all its clients. Beans & Pulses range
              consist of quality beans with rich protein content, like Red Kidney Bean, Black Kidney
              Bean, Red Speckled Kidney Bean, Light Speckled Kidney Bean, Pinto Bean, Green Mung
          ...
          <div className="grid grid-cols-1 md:grid-row-3 gap-8">
            <div>
              <h3 className="text-lg font-bold mb-2">
                Producing high-quality tea with the most advanced technology and equipment
              </h3>
      ...
      <div className="bg-white py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
            <img src={certificate} alt="Certificate 1" className="rounded-2xl m-2 shadow-lg" />
            <img src={certificate} alt="Certificate 2" className="rounded-2xl m-2 shadow-lg" />
            <img src={certificate} alt="Certificate 3" className="rounded-2xl m-2 shadow-lg" />
            <img src={certificate} alt="Certificate 4" className="rounded-2xl m-2 shadow-lg" />
          </div>
        </div>
      </div>
