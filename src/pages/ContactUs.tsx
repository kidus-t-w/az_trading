    ...
    <div className="flex flex-col items-center justify-center mt-28 mb-4">
      <div className="bg-gray-100 py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mb-12">
            Please feel free to get in touch using the form below. We'd love to hear your thoughts &
          ...
          <div className="flex flex-col md:flex-row items-center bg-white p-8 rounded shadow-lg lg:h-[50vh]">
